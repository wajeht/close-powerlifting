...
export const AboutPage: FC<{ state: AppState }> = ({ state }) => (
  <MainLayout state={state} path="/about" title="About">
    <div class="mx-auto max-w-5xl px-4">
      ...
      <div class="flex flex-col gap-6 leading-relaxed text-neutral-400">
        ...
        <section class="fade-in animation-delay-3">
          ...
          <p class="mt-3">
            Close Powerlifting was created to solve exactly that problem. Instead of spending days
            or weeks writing scrapers, handling edge cases, and normalizing data formats, developers
            can now query the entire database with a simple, well-documented REST API.
          </p>
          <p class="mt-3">
            Whether you're building a coaching dashboard to track your athletes, analyzing
            historical strength trends, or just want to look up your own competition history
            programmatically — this API makes it possible in minutes, not days.
          </p>
