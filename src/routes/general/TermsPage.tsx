    ...
    <div class="fade-in animation-delay-2 flex flex-col gap-6 leading-relaxed text-neutral-400">
      ...
      <section>
        ...
        <p class="mt-3">
          ...
          with these Terms and Conditions. By accessing or using the Service You agree to be bound
          by these Terms and Conditions. If You disagree with any part of these Terms and Conditions
