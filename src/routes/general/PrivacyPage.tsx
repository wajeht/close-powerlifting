...
const ContactLink: FC = () => (
  <a
    ...
    href="https://github.com/wajeht/close-powerlifting/issues/new/choose"
    target="_blank"
  >
    contact us
  </a>
...
export const PrivacyPage: FC<{ state: AppState }> = ({ state }) => (
  <MainLayout state={state} path="/privacy" title="Privacy Policy">
      ...
      <div class="fade-in animation-delay-2 flex flex-col gap-6 leading-relaxed text-neutral-400">
        ...
        <section>
          ...
          <p class="mt-3">
            ...
            items such as name and email address.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            visitors when they visit websites. The information collected by log files include
            ...
            information is for analyzing trends, administering the site, and gathering demographic
            information.
          </p>
        </section>
        ...
        <section>
          ...
          <p class="mt-3">
            If you make a request, we have one month to respond to you. Please <ContactLink /> to
        ...
        <section>
          ...
          <p>
            ...
            information on our website, we strongly encourage you to <ContactLink /> immediately and
