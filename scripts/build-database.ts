...
import type { Entry, EquipmentGroup, RecordCategory, RankMetric } from "../src/data/types";
...
function buildFederations(db: DatabaseType): void {
  db.exec(`
...
function buildLifterBests(db: DatabaseType): void {
  db.exec(`
...
function buildRecords(db: DatabaseType): void {
  db.exec(`
