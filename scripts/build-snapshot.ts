...
function toColumns(entries: Entry[]): EntriesColumns {
  ...
  const cols: EntriesColumns = {
    count,
    lifterId: new Array<number>(count),
    meetId: new Array<number>(count),
    sex: new Array<string | null>(count),
    age: new Array<number | null>(count),
    ageClass: new Array<string | null>(count),
    division: new Array<string | null>(count),
    lifterCountry: new Array<string | null>(count),
    lifterState: new Array<string | null>(count),
    event: new Array<string>(count),
    equipment: new Array<string>(count),
    tested: new Array<number>(count),
    bodyweightKg: new Array<number | null>(count),
    weightClassKg: new Array<number | null>(count),
    squat1Kg: new Array<number | null>(count),
    squat2Kg: new Array<number | null>(count),
    squat3Kg: new Array<number | null>(count),
    squat4Kg: new Array<number | null>(count),
    bench1Kg: new Array<number | null>(count),
    bench2Kg: new Array<number | null>(count),
    bench3Kg: new Array<number | null>(count),
    bench4Kg: new Array<number | null>(count),
    deadlift1Kg: new Array<number | null>(count),
    deadlift2Kg: new Array<number | null>(count),
    deadlift3Kg: new Array<number | null>(count),
    deadlift4Kg: new Array<number | null>(count),
    best3SquatKg: new Array<number | null>(count),
    best3BenchKg: new Array<number | null>(count),
    best3DeadliftKg: new Array<number | null>(count),
    totalKg: new Array<number | null>(count),
    placeRank: new Array<number | null>(count),
    placeStatus: new Array<string | null>(count),
    dots: new Array<number | null>(count),
    wilks: new Array<number | null>(count),
    glossbrenner: new Array<number | null>(count),
    goodlift: new Array<number | null>(count),
  };
