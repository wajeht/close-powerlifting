...
function Un(e) {
  ...
  return (
    (e = ds(e)), t && !e.dynamicChildren && (e.dynamicChildren = t.filter((t) => t !== e)), e
  );
}
function Dn(e, t) {
      ...
      : St(e)
        ...
        : E(e)
          ? ((a = !0),
            ...
            (i = () =>
              e.map((e) => (Rt(e) ? e.value : St(e) ? eo(e) : F(e) ? Yt(e, s, 2) : void 0))))
          : (i = F(e)
              ? t
                ? () => Yt(e, s, 2)
                : () => {
...
function da(e, t, n) {
  ...
  return (
    ya(e, t), 2 !== n && 3 !== n && o.includes("&") ? e.options.decodeEntities(o, 4 === n) : o
  );
}
function ha(e) {
